...
const EMAILJS_CONFIG = {
    serviceId: 'YOUR_SERVICE_ID', // Your EmailJS Service ID (example: service_xxxxxxx)
    templateId: 'template_2ypssat', // Your EmailJS Template ID
    publicKey: 'x6gxJb7A428jXaRI8', // Your EmailJS Public Key
